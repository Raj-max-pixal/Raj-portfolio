...
export const featuredProjects: Project[] = [
  {
    ...
    github: 'https://github.com/Raj-max-pixal/Maxie',
    live: 'https://github.com/Raj-max-pixal/Maxie',
    featured: true,
    category: 'AI',
  ...
  },
  {
    ...
    github: 'https://github.com/Raj-max-pixal/multimax-ai-hub',
    featured: true,
    category: 'AI',
  ...
  },
  {
    ...
    github: 'https://github.com/Raj-max-pixal/CareerForge-AI',
    featured: true,
    category: 'AI',
  ...
  },
  {
    ...
    github: 'https://github.com/Raj-max-pixal/ecomind-ai',
    featured: true,
    category: 'AI',
...
export const otherProjects: Project[] = [
  {
    ...
    tech: ['Python', 'AI'],
    github: 'https://github.com/Raj-max-pixal/janvoice-ai',
    featured: false,
    category: 'AI',
  ...
  },
  {
    ...
    features: ['Web App'],
    tech: ['React', 'Node.js'],
    github: 'https://github.com/Raj-max-pixal/techbuilt',
    featured: false,
    category: 'Web',
  ...
  },
  {
    ...
    tech: ['React', 'Firebase'],
    github: 'https://github.com/Raj-max-pixal/votemate-ai',
    featured: false,
    category: 'Web',
  ...
  },
  {
    ...
    tech: ['Flutter', 'API'],
    github: 'https://github.com/Raj-max-pixal/AnimeVerse-',
    featured: false,
    category: 'Mobile',
  ...
  },
  {
    ...
    tech: ['Flutter', 'Firebase'],
    github: 'https://github.com/Raj-max-pixal/multimax.food',
    featured: false,
    category: 'Mobile',
    gradient: 'from-orange-600/30 to-red-500/20',
  },
  ...
  },
  {
    ...
    tech: ['Flutter'],
    github: 'https://github.com/Raj-max-pixal/Premium-calculator',
    featured: false,
    category: 'Mobile',
  ...
  },
  {
    ...
    tech: ['Flutter'],
    github: 'https://github.com/Raj-max-pixal/Tempimax',
    featured: false,
    category: 'Mobile',
